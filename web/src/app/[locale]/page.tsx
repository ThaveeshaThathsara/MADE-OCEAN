...
import { Link as NextUILink } from '@nextui-org/link'; // Renamed for clarity
...
import NextLink from 'next/link'; // Use this for internal navigation
  ...
  return (
    <section className='relative'>
        ...
        <section className='flex flex-col items-center justify-center gap-4 py-8 md:py-10'>
          <div className='flex relative z-20 flex-col gap-6 w-full lg:w-1/2 xl:mt-10'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-4 justify-center'>
              {/* FIXED: Use NextLink with NextUI styling */}
              <NextLink
                href='/test'
                className={clsx(
                  buttonStyles({
              ...
              {/* External links can still use NextUILink */}
              <NextUILink
                isExternal
                className={clsx(
                  buttonStyles({
      ...
      <div className='text-center mx-2'>
        <NextLink href='/articles' className='text-foreground'>
